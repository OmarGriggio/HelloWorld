...
public class VersementMapper extends Mapper {
  ...
  public List<VersementAllocationNaissance> findAllVersementAllocationNaissance() {
    ...
    try {
      ...
      logger.info("Nombre de versements allocation naissance trouvés : {}", versements.size());
      return versements;
    } catch (SQLException e) {
      logger.error("Erreur lors de la recherche des versements allocation naissance", e);
  ...
  public List<VersementAllocation> findAllVersementAllocation() {
    ...
    try {
      ...
      logger.info("Nombre de versements allocations trouvés : {}", versements.size());
      return versements;
    } catch (SQLException e) {
      logger.error("Erreur lors de la recherche des versements allocations", e);
      throw new RuntimeException(e);
    }
  }
  ...
  public List<VersementParentEnfant> findVersementParentEnfant() {
    ...
    try {
      ...
      logger.info("Nombre de versements parents-enfants trouvés : {}", versements.size());
      return versements;
    } catch (SQLException e) {
  ...
  public List<VersementParentParMois> findVersementParentEnfantParMois() {
    ...
    try {
      PreparedStatement preparedStatement = connection
          .prepareStatement(QUERY_FIND_ALL_VERSEMENTS_PARENTS_ENFANTS_PAR_MOIS);
      ResultSet resultSet = preparedStatement.executeQuery();
      ...
      logger.info("Nombre de versements parents-enfants par mois trouvés : {}", versements.size());
      return versements;
    } catch (SQLException e) {
